...
fn expand_cosmos(c: &Vec<Vec<u8>>, expansion_factor: usize) -> (Vec<usize>, Vec<usize>) {
...
fn main() {
    ...
    let position_mapping_1 = expand_cosmos(&cosmos, 2);
    ...
    let position_mapping_2 = expand_cosmos(&cosmos, 1_000_000);
